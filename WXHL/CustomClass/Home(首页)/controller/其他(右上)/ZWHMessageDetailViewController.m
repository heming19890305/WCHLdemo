//
//  ZWHMessageDetailViewController.m
//  WXHL
//
...
@interface ZWHMessageDetailViewController ()<UIWebViewDelegate,WKUIDelegate,WKNavigationDelegate,UIScrollViewDelegate>
...
@implementation ZWHMessageDetailViewController
...
- (void)viewDidLoad {
    ...
    [titleL textFont:15 textColor:[UIColor blackColor] backgroundColor:[UIColor clearColor] textAlignment:NSTextAlignmentCenter];
    titleL.text = _mestitle;
    [self.view addSubview:titleL];
    titleL.sd_layout
    .centerXEqualToView(self.view)
    .topSpaceToView(self.view, HEIGHT_TO(8))
    .autoHeightRatio(0)
    .widthRatioToView(self.view, 0.8);
    
    UILabel *timeL=  [[UILabel alloc]init];
    [timeL textFont:14 textColor:ZWHCOLOR(@"646363") backgroundColor:[UIColor clearColor] textAlignment:NSTextAlignmentCenter];
    timeL.text = _time;
    [self.view addSubview:timeL];
    timeL.sd_layout
    .centerXEqualToView(self.view)
    .topSpaceToView(titleL, HEIGHT_TO(8))
    .autoHeightRatio(0)
    .widthRatioToView(self.view, 0.8);
    
    UIView *line = [[UIView alloc]initWithFrame:CGRectMake(0, HEIGHT_TO(60), SCREENWIDTH, 1)];
    ...
    _webView = [[WKWebView alloc] initWithFrame:CGRectMake(0, 2+HEIGHT_TO(60), SCREEN_WIDTH, SCREEN_HEIGHT - 66 - HEIGHT_TO(60)) configuration:wkWebConfig];
