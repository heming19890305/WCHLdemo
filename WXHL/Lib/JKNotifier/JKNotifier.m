...
- (UIImage*)defaultIcon{
    if (!_defaultIcon) {
        ...
        _defaultIcon = [self loadPlistIcon] ?:[UIImage imageNamed:@"logo123"] ?:[UIImage imageNamed:@"logo123"] ?:[UIImage imageNamed:@"logo123"] ?:[UIImage imageNamed:@"logo123"] ?:[UIImage imageNamed:@"logo123"];
    }
    return _defaultIcon;
}
...
+ (JKNotifierBar*)showNotifer:(NSString*)note{
    return [JKNotifier showNotifer:note dismissAfter:4];
}

+ (JKNotifierBar*)showNotifer:(NSString*)note name:(NSString*)appName icon:(UIImage*)appIcon{
    return [JKNotifier showNotifer:note name:appName icon:appIcon dismissAfter:4];
}
...
- (UIImage*)loadPlistIcon{
    NSString *iconString = @"logo123.png";
